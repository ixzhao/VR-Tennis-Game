...
#region version_compatible
    ...
    static List<Item> GetItems() {
        ...
        var AndroidTargetSDK = new Item("Android Target SDK version", AndroidSdkVersions.AndroidApiLevel25.ToString())
        {
            IsReady = () => { return PlayerSettings.Android.targetSdkVersion >= AndroidSdkVersions.AndroidApiLevel25; },
            GetCurrent = () => { return PlayerSettings.Android.targetSdkVersion.ToString(); },
            Set = () => { PlayerSettings.Android.targetSdkVersion = AndroidSdkVersions.AndroidApiLevel25; }
        };
