...
static class CustomBuildProcessor
{
    ...
    private static string minWaveSDKVersion = "3.0.0";
    private static string numDoFHmd = "6";
    private static string numDoFController = "3";
    private static string numController = "1";
